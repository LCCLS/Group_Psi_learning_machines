...
class Robot:
    ...
    def __init__(self, simulated: bool = False, address: str = '127.0.0.1'):
        ...
        self._food_q_matrix = np.full(((2 ** AMOUNT_IMAGE_SPLITS) * 2, AMOUNT_ACTIONS), 0)
    ...
    def train(self, task: Task, iterations: int = 10000):
        ...
        for i in range(iterations):
            ...
            if task == Task.COLLECT_FOOD:
                reached_goal = self._collected_food()
            else:
                reached_goal = False
            # Reset if goal is reached
            if reached_goal or count % 300 == 0:  #
                count = 0
    ...
    def _collected_food(self):
        ...
        return center_sensor_value and center_sensor_value < SENSOR_SENSITIVITY
    ...
    def _get_current_state_index(self, task: Task):
        ...
        if task == Task.COLLECT_FOOD:
            ...
            if center_sensor_value and center_sensor_value < 0.09:
                ...
                prefix = '0'
                print(" NOT ", end='')
            base_two_val = prefix + base_two_val
            print("")
